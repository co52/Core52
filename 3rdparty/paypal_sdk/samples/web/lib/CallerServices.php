...
require_once PAYPALSDK_BASE_DIR.'/Log.php';
require_once PAYPALSDK_BASE_DIR.'/Log/file.php';
...
class CallerServices {
	...
	/*
   	 * Calls the actual WEB Service and returns the response.
   	 */
	function callWebService($request,$serviceName)
	{
		$response = null;
   ...
   //Set proxy name to PROXY_HOST and port number to PROXY_PORT in constants.php
    ...
    if (curl_errno($ch)) {
        // moving to display page to display curl errors
          ...
          throw new Exception('CURL error ('.curl_errno($ch)."): ".curl_error($ch).': '.print_r(curl_getinfo($ch), TRUE), curl_errno($ch));
     } else {
         //closing the curl
            curl_close($ch);
      }
