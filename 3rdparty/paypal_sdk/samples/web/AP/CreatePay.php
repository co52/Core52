...
<body>
  <center>
    <form action="CreatePayReceipt.php" method="post">
      <table class="api">
       <tr>
          <td colspan="2" class="header"><center><u>Pay - Create, Set, Execute API Flow</u><br></br></center> </td>
        </tr>
        <tr>
          <td colspan="2" class="header"><center>Adaptive Payments -
          CreatePay</center></td>
        </tr>
