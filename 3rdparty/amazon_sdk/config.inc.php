 ...
 * Credentials.
 */
define('AWS_ACCOUNT_ID', $aws_account_id);
 ...
 */
define('AWS_CERTIFICATE_AUTHORITY', $aws_certificate_authority);
 ...
 * ));
 */
define('AWS_DEFAULT_CACHE_CONFIG', $aws_default_cache_config);
 ...
 */
define('AWS_MFA_SERIAL', $aws_mfa_serial);
 ...
 */
define('AWS_CLOUDFRONT_KEYPAIR_ID', $aws_cloudfront_keypair_id);
 ...
 */
define('AWS_CLOUDFRONT_PRIVATE_KEY_PEM', $aws_cloudfront_private_key_pem);
 ...
 */
define('AWS_ENABLE_EXTENSIONS', $aws_enable_extensions);
