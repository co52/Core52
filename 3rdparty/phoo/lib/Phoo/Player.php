...
class Player
{
     ...
     * @ return string
     */
    public function asEmbedScript($secure = false)
    {
		// HTTPS or HTTP?
		if ($secure) {
			$base_url = 'https://www.ooyala.com';
		} else {
			$base_url = 'http://player.ooyala.com';
		}
	
        return '<script src="' . $base_url . '/player.js?' . $this->queryString() . '"></script>';
    }
}